...
const OrderDetails = async ({ params }: { params: { orderId: string }}) => {
  ...
  return (
    <div className="flex flex-col p-10 gap-5">
      ...
      <p className="text-base-bold">
        Shipping address: <span className="text-base-medium">{shippingAddress.line1}, {shippingAddress.city}, {shippingAddress.country}</span>
      </p>
      <p className="text-base-bold">
        Phone number: <span className="text-base-medium">Rs. {shippingAddress.phone}</span>
      </p>
      <p className="text-base-bold">
        Total Paid: <span className="text-base-medium">Rs. {orderDetails.totalAmount}</span>
      </p>
      <p className="text-base-bold">
